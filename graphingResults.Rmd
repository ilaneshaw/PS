...
cbPalette2 <-  c( "#56B4E9",  "#0072B2","#009E73", "#F0E442","#E69F00","#D55E00", "#CC79A7", "#999999","black")
...
forClassRasterLocation <- checkPath(file.path(inputsDir, "forestClassRasters/vegTypesRas_AB_BCR6"), create = TRUE)
ageRasterLocation <- checkPath(file.path(inputsDir, "forestClassRasters/ageRas_AB_BCR6"), create = TRUE)
landClassRasterLocation <- checkPath(file.path(inputsDir, "forestClassRasters/landCoverRas_AB_BCR6"), create = TRUE)
...
```
## LANDSCAPE PLOTS FOR SINGLE STUDY AREA
...
#LANDSCAPE PLOTS FOR TWO STUDY AREAS
