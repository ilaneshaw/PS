...
```{r inputLandscapeRasters, include=FALSE}
...
# make bar chart of different landForClass
    ...
    plotClassCounts <- ggplot(data = landDatStats,
       ...
       scale_fill_manual(values = coloursViridis) +
...
######################################################################################################################################################################################################################################
 ...
 ageRefTab$ageClass <- as.factor(ageRefTab$ageClass)
 ageRefTab
...
forClassDat_age %>% pivot_longer(cols = "age")
 ...
 forClassStats_age <- forClassDat_age[order(ageClass)
  ...
  AB9 <- list( 9, 0, 0)
  AB10 <- list(10, 0, 0)
   forClassStats_age <- rbind(forClassStats_age, AB9, AB10)
   forClassStats_age
...
sp.labs <- c("Alder Flycatcher", "American Goldfinch", "American Robin", "Barn Swallow", "Bay-breasted Warbler", "Black-capped Chickadee", "Brown-headed Cowbird", "Boreal Chickadee","Brewer's Blackbird", "Brown Creeper", "Clay-colored Sparrow", "Cedar Waxwing", "Chipping Sparrow", "Cliff Swallow", "Cape May Warbler", "Common Yellowthroat", "Dark-eyed Junco", "Golden-crowned Kinglet", "Gray Jay", "Hermit Thrush", "House Wren", "Least Flycatcher", "Mourning Warbler", "Ovenbird", "Palm Warbler", "Red-breasted Nuthatch", "Ruby-crowned Kinglet", "Red-eyed Vireo", "Swainson’s Thrush", "Tennessee Warbler", "Yellow-rumped Warbler" )
names(sp.labs) <- c("ALFL", "AMGO", "AMRO", "BARS", "BBWA", "BCCH", "BHCO","BOCH", "BRBL", "BRCR", "CCSP", "CEDW", "CHSP", "CLSW", "CMWA", "COYE", "DEJU", "GCKI", "GRAJ", "HETH", "HOWR", "LEFL", "MOWA", "OVEN", "PAWA", "RBNU", "RCKI", "REVI", "SWTH", "TEWA", "YRWA") 

birdPreds1DSingleFrame <- rbindlist(birdPreds1D[1:31])
...
plotMeanBirdDensity <- ggplot(data = birdPreds1DSingleFrame,
    ...
    #scale_fill_viridis(option = "E", discrete = TRUE)+
     geom_bar(stat = "identity",
           width = 0.7) +
  scale_fill_manual(values = coloursViridis,
                    labels = c("landClass_0" = "Unmanaged Forest", 
                             "landClass_1" = "Water/Ice", 
                             "landClass_2" = "Wetland", 
  ...
  ylab("Mean Density") +
  scale_y_continuous(breaks= pretty_breaks()) +
  scale_x_discrete(labels=c("landClass_0" = "Unmanaged Forest", 
                             "landClass_1" = "Water/Ice", 
                             "landClass_2" = "Wetland", 
                             "landClass_3" = "Anthro/Exposed", 
                             "landClass_4" = "Grass/Crop" , 
  ...
  theme(title = element_text(size = 14),
        ...
        strip.background = element_rect(
          color="white", fill="white", linewidth =0.01),
        axis.text.y = element_text(size = 12),
...
#make dataframe of birds you want to include
dataFrameForGraph <- rbindlist(matrixAsTables[1:16])
#dataFrameForGraph <- rbindlist(matrixAsTables[17:31])



#define facet labels for birds
sp.labs <- c("Alder \nFlycatcher", "American \nGoldfinch", "American\n Robin", "Barn Swallow", "Bay-\nbreasted\n Warbler", "Black-\ncapped\n Chickadee", "Brown-\nheaded\n Cowbird", "Boreal \nChickadee","Brewer's \nBlackbird", "Brown \nCreeper", "Clay-colored\n Sparrow", "Cedar \nWaxwing", "Chipping\n Sparrow", "Cliff\n Swallow", "Cape May\n Warbler", "Common \nYellowthroat", "Dark-eyed\n Junco", "Golden-\ncrowned\n Kinglet", "Gray Jay", "Hermit \nThrush", "House\n Wren", "Least \nFlycatcher", "Mourning\n Warbler", "Ovenbird", "Palm \nWarbler", "Red-\nbreasted\n Nuthatch", "Ruby-\ncrowned\n Kinglet", "Red-eyed\n Vireo", "Swainson’s\n Thrush", "Tennessee\n Warbler", "Yellow-\nrumped\n Warbler" )
names(sp.labs) <- c("ALFL", "AMGO", "AMRO", "BARS", "BBWA", "BCCH", "BHCO","BOCH", "BRBL", "BRCR", "CCSP", "CEDW", "CHSP", "CLSW", "CMWA", "COYE", "DEJU", "GCKI", "GRAJ", "HETH", "HOWR", "LEFL", "MOWA", "OVEN", "PAWA", "RBNU", "RCKI", "REVI", "SWTH", "TEWA", "YRWA") 


# New facet label names for forest classes
class.labs <- c("Black Spruce", "Black Spruce Wet", "Deciduous", "Mixed", "Pine", "White Spruce")
names(class.labs) <- c("1", "2", "3", "4", "5", "6")



plotMeanBirdDensity2D <- ggplot(data = dataFrameForGraph,
                                aes(fill= forClass, y= birdDensityPred, x= ageClass)) +
  ...
  scale_fill_manual(values = coloursFor) +
  #scale_fill_viridis(option = "E",discrete = TRUE) +
  ggtitle("Predicted density by forest and age class") +
  xlab("Age (yrs)")  +
...
class.labs <- c("Forested", "Water/Ice", "Wetland", "Anthro/Exposed", "Grass/Crop", "Shrub", "Bryoid", "Black Spruce", "Black Spruce Wet", "Deciduous", "Mixed", "Pine", "White Spruce")
names(class.labs) <- c("landClass_0", "landClass_1", "landClass_2", "landClass_3", "landClass_4", "landClass_5", "landClass_6", "forClass_1", "forClass_2", "forClass_3", "forClass_4", "forClass_5", "forClass_6")
  ...
  densityPlot <-  ggplot(birdDatasets$OVEN, aes(x=birdDensity, fill=factor(landForClass))) +
  geom_density() +
    scale_fill_manual(values = coloursViridis) +
    #scale_fill_viridis(option = "E",discrete = TRUE) +
    facet_wrap( ~ landForClass, 
    labeller = labeller(landForClass = class.labs), scales = "free_y") +
    theme_classic() +
  ggtitle("Kernel density plots for Ovenbird by forest or land cover class") +
...
nmRas <- terra::rast(paste(outputsDir, "/outputBirdPredsRasters/", bird,"-meanBoot_BCR-60_studyArea_AB_BCR6", sep = ""))
...
names(allRasters) <- c("BAM National Model", "Smoothing Prediction", "Residual")
# Convert rasters to data frames
# nmRas_df <- as.data.frame(nmRas, xy = TRUE, cells = TRUE) %>%
#   rename(value = "OVEN-meanBoot_60") %>%
#   mutate(layer = "NM")
# 
# mapRas_df <- as.data.frame(mapRas, xy = TRUE, cells = TRUE) %>%
#   rename(value = "OVEN") %>%
#   mutate(layer = "Map")
# 
# resRas_df<- as.data.frame(resRas, xy = TRUE, cells = TRUE) %>%
#   rename(value = "OVEN") %>%
#   mutate(layer = "Res")

# Combine data frames
#df_combined <- bind_rows(nmRas_df, mapRas_df, resRas_df)
...
rasterPlot <- ggplot() +
  ...
  theme_minimal()+
  labs(title = "Ovenbird density predictions (males/ha)")+
   theme(title = element_text(size = 14),
        strip.text.x = element_text(
          size = 14),
        strip.text.y = element_text(
...
plot(allRasters, main = c('National Model', "Mapped Predictions", "residuals"), colNA="white", range = r.range, col = coloursViridis, axes=FALSE, box=FALSE, cex.main = 1.5)), plg=list( cex = 1.25  ))
...
# plot(mapRas, main = 'Mapped Predictions', colNA="white", range = r.range, col = coloursViridis, axes=FALSE, box = FALSE, legend = FALSE, cex.main = 1.5)plot(mapRas, mTRUEain = 'Mapped Predictions', colNA="white", range = r.range, col = coloursViridis, axes=FALSE, box = FALSE, legend = FALSE, cex.main = 1.5)
# plot(resRas, main = 'Residuals', colNA="white", range = r.range, col = coloursViridis, axes=FALSE, box = FALSE, cex.main = 1.5, plg=list( cex = 1.25 # Legend text size
#             ))
