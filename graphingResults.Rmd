...
commonName <- c("Alder Flycatcher", "Bay-breasted Warbler", "Black-capped Chickadee", "Boreal Chickadee", "Brown Creeper", "Cape May Warbler", "Common Yellowthroat", "Dark-eyed Junco", "Golden-crowned Kinglet", "Gray Jay", "Least Flycatcher", "Mourning Warbler", "Ovenbird", "Palm Warbler", "Red-breasted Nuthatch", "Ruby-crowned Kinglet", "Red-eyed Vireo", "Swainson’s Thrush", "Tennessee Warbler", "Yellow-rumped Warbler")
...
statsGBM <- as.data.table(read_csv(paste(outputsDir,  "/5x40yrAgeClasses/outputBirdPreds/studyArea_AB_BCR6.shp_statsGBM.csv", sep = "")))
...
#plot_grid(plotRelInf, plotFrH, labels = c('A', 'B'), label_size = 12)
 ...
 theme(title = element_blank(),
  ...
  plotGBM
   ...
   ggsave(file.path(saveLocation,"statsGBM_40yrAgeClasses.jpeg"), plotGBM, width = 18, height = 16, units = "cm")
...
plotAutocorStats <- ggplot(data = moranStats,
 ...
 #################################################################  
   ...
   ggsave(file.path(saveLocation,"unimodSpearmanAutocor.jpeg"), allMatrixPlot, width = 10, height = 18, units = "cm")
...
gtTab <- gt::gt(spearmanStats) |> #tab_options(table.border.right.width = 50) |> 
  tab_header(title = "Spearman's Rank Correlation Test Statistic") |>
...
names(allRasters) <- c("BAM Model Raster", "2D Smoothing Prediction", "Residual")
...
ggsave(file.path(paste(saveLocation, "/", bird, "_rasterPlots.jpeg", sep = "")), rasterPlot, width = 22, height = 12, units = "cm")
