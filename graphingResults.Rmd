...
names(allRasters) <- c("BAM Model Raster", "2D Smoothing Prediction\n (10 year age classes)", "Residual")
...
ggsave(file.path(saveLocation,"rasterPlots.jpeg"), rasterPlot, width = 22, height = 12, units = "cm")
...
# plot(allRasters, 
#      main = c('National Model', "Mapped Predictions", "residuals"), 
#      colNA="white", 
#      range = r.range, 
#      #col = coloursViridis, 
#      axes=FALSE, 
