...
##(single study area) summary landscape plots
...
allLandRasters <- c( forClassRaster, nonForRaster, landscapeRaster, 
 ...
 landDatStats <- allLandData[order(FNFRaster, 
     ...
     studyArea <- rep("AB", each = nrow(landDatStats))
     landDatStats <-cbind(landDatStats, studyArea) 
...
# make bar chart of different uniqueClasses
   ...
   scale_x_discrete(labels=c("0_0" = "Unmanaged\n Forest", "0_1" = "Water/Ice", "0_2" = "Wetland", "0_3" = "Anthro/\nExposed", "0_4" = "Grass/\nCrop" , "0_5" = "Shrub", "0_6" = "Bryoid", "1_7" = "White \nSpruce", "1_1" = "Black \nSpruce", "1_2" = "  Black  \nSpruce Wet", "1_6" = "Pine", "1_3" = "Conifer Mix",  "1_5" = "Mixed", "1_4" = "Deciduous"  )) +
    theme(title = element_text(size = 16),
        axis.text.y = element_text(size = 12),
        axis.text.x = element_text(size = 12, angle = 45, hjust = 1),
        axis.title.y = element_text(size = 14),
...
## (single study area) landscape rasters maps
...
# GET RASTERS
 ...
 #get rasterToMatch
   ...
   fcrValue <- c(1, 2, 3, 4, 5, 6, 7)
   fcrLabel <- c("1", "2", "3", "4", "5", "6", "7")
   fcrLabelReclass <- c( "Black Spruce", "Black Spruce Wet", "Conifer Mix", "Deciduous", "Mixed", "Pine", "White Spruce")
  ...
  nonForRaster <- categories(nonForRaster, value=lcrReclassified, active = 2)
...
plot(forClassRaster, main = 'Forest class raster', legend = TRUE, col = cbPalette, colNA="white", axes=FALSE, box=FALSE)
# legend("bottomright", legend = c( "Black Spruce", "Black Spruce Wet", "Conifer Mix", "Deciduous", "Mixed", "Pine", "White Spruce"), fill = cbPalette)

#nonForRaster
#plot(nonForRaster,colNA="grey70")
# customizing the legend
plot(nonForRaster, main = 'Land class raster', legend = TRUE, col = cbPalette, colNA="white", axes=FALSE, box=FALSE)
