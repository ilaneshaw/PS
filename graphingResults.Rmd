...
ggsave(file.path(saveLocation,"1DResults.jpeg"), plotMeanBirdDensity, width = 22, height = 30, units = "cm")
...
#datasetWanted <- paste("birdDatasets$", spOfInterest, sep = "")
  ...
  geom_density() +
    ...
    scales = "free_y") +
    theme_classic() +
  ggtitle(paste("Kernel density plots for ", spFullName, " by forest or land cover class", sep = "")) +
  ...
  ggsave(file.path(saveLocation,"densityPlot.jpeg"), densityPlot, width = 16, height = 17, units = "cm")
...
plotAutocorStats <- ggplot(data = moranStats,
    ...
    ylab("Moran's I") +
    scale_y_continuous(breaks= pretty_breaks()) +
    scale_x_discrete(labels=c("moran1D" = "1D Piecewise\n Smoothing", "moran2D" = "2D Piecewise\n Smoothing")) +       theme_classic() + 
    scale_fill_manual(values= colours1D2D, 
                      labels = c( "moran1D", "moran2D")) +
    theme(title = element_text(size = 12),
          legend.title = element_blank(),
