---
title: "PS Manual"
subtitle: "v.`r SpaDES.core::moduleMetadata(module = 'PS', path = file.path('../../modules'))$version`"
...
`r paste(as.character(SpaDES.core::moduleMetadata(module = "PS", path = file.path("../../modules"))$authors), sep = ', ')`
...
If `sourceURL` is specified, `downloadData("PS", file.path("../../modules"))` may be sufficient.
...
df_inputs <- SpaDES.core::moduleInputs("PS", file.path("../../modules"))
...
df_params <- SpaDES.core::moduleParams("PS", file.path("../../modules"))
...
df_outputs <- SpaDES.core::moduleOutputs("PS", file.path("../../modules"))
...
simParams <- list(
  PS = list(
    ...
    .plotInitialTime = 1,
    .saveInitialTime = 1,
    nTrees = 10, # 5000, #glm number of trees (may want to do it with fewer)
    ...
    .studyAreaName = .studyAreaName, # specify name of the study area .shp
